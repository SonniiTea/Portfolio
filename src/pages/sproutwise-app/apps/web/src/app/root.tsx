...
/** Tailwind — use a real `<link>` so dev mode keeps styles when React Router strips injected CSS. */
  ...
  return (
    <html lang="en">
      <head>
        ...
        <Meta />
        <Links />
        <link rel="stylesheet" href={globalCssUrl} data-sproutwise-global-css />
