...
// Side-effect import alone does not put Tailwind in SSR <head>; external browsers
// then paint unstyled HTML until (or unless) client JS attaches CSS. Use ?url + links().
...
export function Layout({ children }: { children: ReactNode }) {
  ...
  /** Match SSR (false) on first client paint to avoid hydration mismatches. */
